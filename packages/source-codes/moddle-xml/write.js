import { forEach, isString, filter, assign, has, findIndex } from 'min-dash'

import { isSimpleType, parseNameNS } from 'moddle'

import { hasLowerCaseAlias, getSerialization, SERIALIZE_PROPERTY, DEFAULT_NS_MAP } from './common.js'
...
ElementSerializer.prototype.parseGenericNsAttributes = function (element) {
  return Object.entries(element)
    .filter(([key, value]) => !key.startsWith('$') && this.parseNsAttribute(element, key, value))
